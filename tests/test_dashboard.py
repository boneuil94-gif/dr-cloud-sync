...
def test_dashboard_only_contains_real_routes_and_no_fictional_metrics():
    ...
    assert {module.route for module in MODULES if module.available} == {
        "/", "/roadmap", "/catalogue", "/inventaire", "/stock", "/achats", "/sales", "/finance", "/settlements", "/marketing", "/marketing/social-analytics", "/marketing/learning", "/administration", "/securite", "/crm"
    }
