...
class InventoryApp:
    def __init__(self, service: InventoryService, report_output: Path | None = None, os_repository=None,
        ...
        self.data_hub.register_job(JobDefinition("sync_sumup_merchant","sumup_merchant","SUMUP_MERCHANT",sumup_interval))
